...
class PYQPatternAnalyzer {
  ...
  Future<List<Map<String, dynamic>>> generateStarterQuestions(
      Map<String, dynamic> pattern) async {
    final questions = <Map<String, dynamic>>[];
    final patternId = pattern['pattern_id'] as String;
      ...
      questions.addAll([
        {
          ...
          'question_text':
              'A square is divided from the center into 4 equal parts. What is each central angle?',
          'options': ['45°', '60°', '90°', '120°'],
          'correct_answer': 2,
          'formulae_used': ['central_angle = 360° / n'],
          'why_wrong_explanations': {
            '0':
                '45° is the central angle of an octagon (8 sides), not a square.',
        ...
        },
        {
          ...
          'question_role': 'starter',
          'question_text':
              'An equilateral triangle is divided from the center into 3 equal parts. What is each central angle?',
          ...
          'why_wrong_explanations': {
            ...
            '1':
                '120° would be for a triangle if it were 3 equal angles, but central angle is different.',
            '2':
                '180° is a straight angle, not a central angle of a regular polygon.'
          },
          'difficulty': 'easy',
          'estimated_time_seconds': 45,
          'diagram_required': true,
        ...
        },
        {
          ...
          'question_role': 'starter',
          'question_text':
              'A regular hexagon has 6 equal sides. What is the central angle of each section?',
          'options': ['45°', '60°', '72°', '90°'],
          'correct_answer': 1,
          'formulae_used': ['central_angle = 360° / n'],
          'why_wrong_explanations': {
        ...
        },
        {
          ...
          'question_role': 'starter',
          'question_text':
              'If a regular polygon has 5 sides, what formula would you use to find the central angle?',
          'options': ['360° × 5', '360° ÷ 5', '180° × 5', '180° ÷ 5'],
          'correct_answer': 1,
          'formulae_used': ['central_angle = 360° / n'],
          'why_wrong_explanations': {
            '0':
                'Multiplying by 5 would give 1800°, which is more than a full circle.',
            '2': '180° × 5 = 900°, which is more than two full circles.',
            '3':
                '180° ÷ 5 = 36°, which is not the correct central angle formula.'
          },
          'difficulty': 'easy',
        ...
        },
        {
          ...
          'options': [
            'Because 360 is divisible by many numbers',
            'Because a full circle is 360°',
            'Because polygons have 360 sides',
            'Because 360° is the largest angle'
          ],
          'correct_answer': 1,
          'formulae_used': ['central_angle = 360° / n'],
          'why_wrong_explanations': {
            '0':
                "While 360 is divisible by many numbers, that's not why we use it in the formula.",
            '2':
                "Regular polygons don't have 360 sides - they have different numbers of sides.",
            '3':
                "360° is not the largest angle - it's a full circle/complete turn."
          },
          'difficulty': 'easy',
          'estimated_time_seconds': 30,
          'diagram_required': false,
      ...
      questions.addAll([
        {
          ...
          'question_text':
              'A regular octagon has a central angle of 45°. If you draw lines from the center to all vertices, how many equal triangles will you create?',
          'options': ['4', '6', '8', '10'],
          'correct_answer': 2,
          'formulae_used': [
            'central_angle = 360° / n',
        ...
        },
        {
          ...
          'question_role': 'practice',
          'question_text':
              'A regular polygon has central angles of 30° each. How many sides does this polygon have?',
          'options': ['6', '8', '10', '12'],
          'correct_answer': 3,
        ...
        },
        {
          ...
          'question_role': 'practice',
          'question_text':
              'Which regular polygon has a larger central angle: a pentagon or a hexagon?',
          'options': [
            'Pentagon',
            'Hexagon',
            'They are equal',
          ...
          'why_wrong_explanations': {
            '1':
                'Hexagon has 6 sides, so central angle = 360° ÷ 6 = 60°, which is smaller.',
            '2':
                'They have different numbers of sides, so central angles are different.',
        ...
        },
        {
          ...
          'question_role': 'practice',
          'question_text':
              'The central angle of a regular polygon is 1/8 of a full circle. What is the central angle in degrees?',
          'options': ['30°', '36°', '45°', '60°'],
          'correct_answer': 2,
          'formulae_used': [
            'central_angle = 360° / n',
            'fraction_of_circle = central_angle / 360°'
          ],
          'why_wrong_explanations': {
        ...
        },
        {
          ...
          'question_role': 'practice',
          'question_text':
              'A regular polygon has 9 sides. What is its central angle as a decimal?',
        ...
        },
        {
          ...
          'question_role': 'practice',
          'question_text':
              'A stop sign is a regular octagon. If you stand at the center and look directly at each corner, how many degrees do you turn to see the next corner?',
          'options': ['30°', '36°', '45°', '60°'],
          'correct_answer': 2,
          'formulae_used': ['central_angle = 360° / n'],
          'why_wrong_explanations': {
  ...
  Future<List<Map<String, dynamic>>> generateChallengeQuestions(
      Map<String, dynamic> pattern) async {
    final questions = <Map<String, dynamic>>[];
    final patternId = pattern['pattern_id'] as String;
      ...
      questions.addAll([
        {
          ...
          'question_text':
              'A regular dodecagon has a central angle of 30°. If you connect every other vertex to the center, what is the new central angle between connected vertices?',
          'options': ['15°', '30°', '45°', '60°'],
          'correct_answer': 3,
          'formulae_used': [
            'central_angle = 360° / n',
            'skipped_vertices = 360° / (n/2)'
          ],
          'why_wrong_explanations': {
            '0':
                '15° would be for connecting every 4th vertex (360° ÷ 3 = 120°, then ÷ 4 = 30°, then ÷ 2 = 15°).',
            '1':
                '30° is the original central angle, not the angle between skipped vertices.',
        ...
        },
        {
          ...
          'question_role': 'challenge',
          'question_text':
              'If a regular polygon has a central angle of (360 ÷ (x + 2)) degrees and has 7 sides, what is the value of x?',
          'options': ['3', '5', '7', '9'],
          'correct_answer': 1,
          'formulae_used': [
            'central_angle = 360° / n',
          ...
          'why_wrong_explanations': {
            '0':
                'If x = 3, then central angle = 360° ÷ 5 = 72°, but 7 sides give 51.43°.',
            '2':
                'If x = 7, then central angle = 360° ÷ 9 = 40°, but 7 sides give 51.43°.',
            '3':
                'If x = 9, then central angle = 360° ÷ 11 = 32.73°, but 7 sides give 51.43°.'
          },
          'difficulty': 'hard',
        ...
        },
        {
          ...
          'question_role': 'challenge',
          'question_text':
              "A regular polygon's central angle is twice that of a regular hexagon. How many sides does this polygon have?",
          'options': ['2', '3', '4', '6'],
          'correct_answer': 1,
          ...
          'why_wrong_explanations': {
            ...
            '2':
                "4 sides (square) has 90° central angle, which is 1.5 times hexagon's 60°.",
            '3':
                '6 sides is the hexagon itself, which would have the same central angle.'
          },
          'difficulty': 'hard',
          'estimated_time_seconds': 90,
          'diagram_required': false,
  ...
  Future<List<Map<String, dynamic>>> generateJEEStyleQuestions(
      Map<String, dynamic> pattern) async {
    final questions = <Map<String, dynamic>>[];
    final patternId = pattern['pattern_id'] as String;
    ...
    if (patternId == 'regular_polygon_central_angle') {
      questions.add({
        ...
        'question_text':
            'A regular polygon has 12 sides. The ratio of its central angle to its interior angle is 2:3. Find the number of diagonals that can be drawn from one vertex.',
        'options': ['8', '9', '10', '11'],
        'correct_answer': 1,
        'formulae_used': [
          'central_angle = 360° / n',
  ...
  Future<void> saveGeneratedQuestions(
      String topic, List<Map<String, dynamic>> questions) async {
    ...
    final questionData = {
      'metadata': {
        ...
        'note':
            'All questions are original content created from pattern analysis. No direct copying from external sources.'
      },
      'questions': questions
    };
