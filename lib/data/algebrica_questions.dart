...
final List<QuestionData> algebricaQuestions = [
  ...
  QuestionData(
    ...
    primaryConcept: 'parabola',
    difficulty: Difficulty.medium,
    estimatedSeconds: 90,
    frequentlyAsked: true,
    highWeightTopic: true,
    commonMistake: 'Students confuse vertex formula with the constant term.',
    correctReason: 'For y = ax² + bx + c, vertex is at x = -b/2a. Here a=1, b=-4, so x = -(-4)/(2×1) = 4/2 = 2. Then y = 2² - 4(2) + 3 = 4 - 8 + 3 = -1. So vertex is (2, -1).',
    whyWrongExplanations: {
      1: 'You selected (2,1) which is the y-intercept (when x=0). The vertex formula x = -b/2a gives 2, not 1.',
      2: 'You selected (4,-1) which is wrong because you used -b/a instead of -b/2a. The correct formula is -b/(2a).',
      3: 'You selected (0,3) which is the y-intercept (c value). This is where the parabola crosses the y-axis, not the vertex.',
    },
    solutionSteps: [
      'Step 1: Identify coefficients a=1, b=-4, c=3',
      'Step 2: Use vertex formula x = -b/(2a) = -(-4)/(2×1) = 4/2 = 2',
      'Step 3: Substitute x=2 into the equation: y = 2² - 4(2) + 3 = 4 - 8 + 3 = -1',
      'Step 4: Vertex is at (2, -1)',
    ],
    similarQuestionIds: [],
    revealSteps: [
      const RevealStep(
  ...
  QuestionData(
    ...
    correctReason: 'Using sin²θ + cos²θ = 1, we get sin²θ = 1 - (0.6)² = 1 - 0.36 = 0.64. Taking square root gives sinθ = ±0.8. Since θ is in the first quadrant (both sin and cos positive), sinθ = 0.8.',
    whyWrongExplanations: {
      1: 'You selected 0.6 which is the value of cosθ, not sinθ. Remember to use the Pythagorean identity to find the other trig function.',
      2: 'You might have calculated sinθ = √(1 - 0.6) = √0.4 = 0.63 instead of √(1 - 0.36). Remember to square the cos value first.',
      3: 'You selected 1.0 which is only possible when θ = 90°. But cos(90°) = 0, not 0.6.',
    },
    commonMistakeTypes: [MistakeType.conceptMisunderstanding, MistakeType.calculation],
    subject: 'Mathematics',
    topic: 'Trigonometry',
    coreConcept: 'Pythagorean identity',
    primaryConcept: 'trig_identities',
    difficulty: Difficulty.easy,
    estimatedSeconds: 45,
    frequentlyAsked: true,
    highWeightTopic: true,
    ...
    solutionSteps: [
      'Step 1: Recall the Pythagorean identity: sin²θ + cos²θ = 1',
      'Step 2: Substitute cosθ = 0.6 → sin²θ + (0.6)² = 1',
      'Step 3: Calculate (0.6)² = 0.36 → sin²θ + 0.36 = 1',
      'Step 4: Solve sin²θ = 1 - 0.36 = 0.64',
      'Step 5: Take square root: sinθ = ±√0.64 = ±0.8',
      'Step 6: Since θ is in first quadrant, sinθ is positive → sinθ = 0.8',
    ],
    similarQuestionIds: [],
    revealSteps: [
      const RevealStep(
  ...
  QuestionData(
    ...
    correctReason: 'For a 2×2 matrix [a,b;c,d], determinant = ad - bc. Here a=3, b=2, c=1, d=4. So det = 3×4 - 2×1 = 12 - 2 = 10.',
    whyWrongExplanations: {
      1: 'You got 14 which is the sum (3+4+2+1) or 3×4 + 2×1. Remember to SUBTRACT: ad - bc.',
      2: 'You got 8 which could be 3×4 - 2 or 3+2+1+2. The correct formula is ad - bc = 3×4 - 2×1 = 12 - 2 = 10.',
      3: 'You got 12 which is just 3×4. Remember to subtract the product of the other diagonal (b×c = 2×1 = 2).',
    },
    subject: 'Mathematics',
    topic: 'Matrices',
    coreConcept: 'Determinant of 2×2 matrix',
    primaryConcept: 'matrices',
    difficulty: Difficulty.easy,
    estimatedSeconds: 45,
    frequentlyAsked: true,
    highWeightTopic: true,
    ...
    solutionSteps: [
      'Step 1: Identify matrix elements: a=3, b=2, c=1, d=4',
      'Step 2: Remember formula: det = ad - bc',
      'Step 3: Calculate diagonal 1: ad = 3 × 4 = 12',
      'Step 4: Calculate diagonal 2: bc = 2 × 1 = 2',
      'Step 5: Subtract: 12 - 2 = 10',
    ],
    similarQuestionIds: [],
    revealSteps: [
      const RevealStep(
